...
## Roadmap
- Full roadmap (including GUI Phase 2 tasks and backend milestones) lives in [docs-site/src/todo/README.md](docs-site/src/todo/README.md) with detailed task breakdowns in [docs-site/src/todo/gui-phase2-tasks.md](docs-site/src/todo/gui-phase2-tasks.md).
